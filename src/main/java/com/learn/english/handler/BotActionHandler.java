...
public interface BotActionHandler {
    List<BotAction> BASE_OPTIONS = List.of(ADD_WORD_WITH_BOT_REQUEST_ORIGINAL, ADD_WORD_WITHOUT_BOT_REQUEST_ORIGINAL, REPEATING_PLANNED, REPEATING_RANDOM);
    List<BotAction> ADD_OPTIONS = List.of(ADD_WORD_WITH_BOT_REQUEST_ORIGINAL, ADD_WORD_WITHOUT_BOT_REQUEST_ORIGINAL);
    ...
    List<SendMessage> processAction(UserState userState, String message);
